...
/** Classe EditarLivros
 * Esta classe é a tela utilizada para alterar as informações dos livros já cadastrados no banco de dados.
 * @version 1.0
 ...
 */   
        ...
        /**
         * Feito para após o usuário administrador preencher todos os dados que serão alterados, o sistema alterará esses dados e mandará o usuário para a tela anterior.
         */
        public void Alterar(){
         ...
         try{
         livro.setId(  Integer.parseInt(this.id));
    ...
    public void PuxarBanco(){
     ...
     String DataConvertida = DataPublicacao.substring(8,10) + "/" + DataPublicacao.substring(5,7) + "/" + DataPublicacao.substring(0,4); 
            ...
            this.jTextField2.setText(Categoria);
             this.jTextField4.setText(Editora);
             this.jTextField5.setText(Autor);
             this.jFormattedTextField1.setText(DataConvertida);
             this.jTextArea1.setText(Sinopse);
 ...
 */
    ...
    /** Neste método é inicializado os componentes para ser feito esta tela! Utiliza-se também setExtendedState(MAXIMIZED_BOTH) para deixar a tela tampando totalmente o monitor. Aqui também é inicializado o método de formatarCampo().
     * 
     */
    ...
    private void initComponents() {
        ...
        jLabel7.setText("Alteração de Livros");
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGap(235, 270, Short.MAX_VALUE))
        );
 ...
 */
     ...
     * Este método acontece quando o usuário clica no botão de Alterar após preencher todos os campos com informação do livro que será cadastrado.
     * @param evt 
     */
 ...
 */
    ...
    /**
     * Esse método é o Main aonde será inicializado e instanciado a tela de Editar Livros.
